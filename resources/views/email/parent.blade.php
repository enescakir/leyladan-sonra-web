...
.image75 img {width: 200px; height: auto;}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full2"  bgcolor="#303030"style="background-color: rgb(48, 48, 48);">
	<tr>
		<td style="background-image:url('http://beta.leyladansonra.com/resources/admin/media/mail_bg.jpg'); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; background-position: center center; background-repeat: no-repeat;" id="not6">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2">
				<tr>
					<td width="100%">
						...
						<!-- Start Top -->
						<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" bgcolor="#4edeb5" style="border-top-left-radius: 5px; border-top-right-radius: 5px; background-color: rgb(51,153,153);" object="drag-module-small">
							<tr>
								<td width="100%" valign="middle" class="image75">
									...
									<table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
										...
										<tr>
											<td width="100%"><span ><img src="http://beta.leyladansonra.com/resources/admin/media/mail_logo.png" width="200" alt="" border="0" ></span></td>
										</tr>
										<tr>
											<td width="100%" height="20"></td>
										</tr>
									...
									<table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
										<tr>
											<td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 23px; color: rgb(63, 67, 69); line-height: 30px; font-weight: 100;">
												<!--[if !mso]><!--><span style="font-family: Helvetica; font-weight: 50;"><!--<![endif]-->Merhaba {{$user->first_name}}, <!--[if !mso]><!--></span><!--<![endif]-->
											</td>
										</tr>
									</table>
								</td>
						...
						<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" object="drag-module-small">
							<tr>
								<td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: rgb(255, 255, 255); line-height: 24px; font-style: italic;">
									<!--[if !mso]><!--><span style="font-family: Helvetica; font-weight: normal;"><!--<![endif]-->
									Bu e-posta Leyla'dan Sonra v2.1 sistemi tarafından otomatik olarak oluşturulmuştur. Eğer bir sorun olduğunu düşünüyorsanız <!--<![endif]--></span><!--[if !mso]><!-->
									
									<!--[if !mso]><!--><span style="font-family: Helvetica;"><!--<![endif]--><!--subscribe--><strong><a href="mailto:teknik@leyladansonra.com" style="text-decoration: none; color: rgb(255, 255, 255);"> buradan </a></strong><!--unsub--><!--[if !mso]><!-->

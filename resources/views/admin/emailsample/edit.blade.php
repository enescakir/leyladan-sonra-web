...
@section('title', 'E-posta Örneği Güncelle')

@section('header')
  <section class="content-header">
    <h1>
      E-posta Örneği Güncelle
      <small>Bu sayfadan sisteme e-posta örneği güncelleyebilirsiniz</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Anasayfa</a></li>
      <li><a href="{{ route('admin.emailsample.index') }}">E-posta Örnekleri</a></li>
      <li class="active">E-posta Örneği Güncelle</li>
    </ol>
  </section>
@endsection
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($emailsample, ['method' => 'PUT', 'route' => ['admin.emailsample.update', $emailsample->id], 'class' => 'form-horizontal']) !!}
        <div class="box-body">

...
@section('title', 'Destekçi Güncelleme')
...
@section('header')
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <a href="{{ route('admin.sponsor.index') }}">Destekçiler</a>
      </li>
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($sponsor, ['method' => 'PUT', 'route' => ['admin.sponsor.update', $sponsor->id], 'class' => 'form-horizontal',
        'files' => true]) !!}
        <div class="box-body">

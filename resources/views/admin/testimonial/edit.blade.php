...
@section('title', 'Referans Güncelle')

@section('header')
  <section class="content-header">
    <h1>
      Referans Güncelle
      <small>Bu sayfadan sisteme referans güncelleyebilirsiniz</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Anasayfa</a></li>
      <li><a href="{{ route('admin.testimonial.index') }}">Referanslar</a></li>
      <li class="active">Referans Güncelle</li>
    </ol>
  </section>
@endsection
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="box box-danger">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($testimonial, ['method' => 'PUT', 'route' => ['admin.testimonial.update', $testimonial->id], 'class' => 'form-horizontal']) !!}
        <div class="box-body">
          ...
          <div class="form-group{{ $errors->has('priority') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
              <div class="btn-group" data-toggle="buttons">
                ...
                <label class="btn btn-ls @if(old('priority') == $key || $testimonial->priority == $key) active @endif">

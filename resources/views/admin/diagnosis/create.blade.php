...
@section('title', 'Tanı Ekle')
  
@section('header')
  <section class="content-header">
    <h1>
      Tanı Ekle
      <small>Bu sayfadan sisteme tanı ekleyebilirsiniz</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Anasayfa</a></li>
      <li><a href="{{ route('admin.diagnosis.index') }}">Tanılar</a></li>
      <li class="active">Tanı Ekle</li>
    </ol>
  </section>
@endsection
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="box box-danger">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::open(['method' => 'POST', 'route' => 'admin.diagnosis.store', 'class' => 'form-horizontal']) !!}
        <div class="box-body">

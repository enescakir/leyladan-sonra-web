...
@section('title', 'Gönüllü Güncelleme')

@section('header')
    <section class="content-header">
        <h1>
            Gönüllü Güncelleme
            <small>Bu sayfadan sistemdeki gönüllü güncelleyebilirsiniz</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li><a href="{{ route('admin.volunteer.index') }}">Gönüllüler</a></li>
            <li class="active">Gönüllü Güncelleme</li>
        </ol>
    </section>
@endsection

@section('content')
    {!! Form::model($volunteer, ['method' => 'PUT', 'route' => ['admin.volunteer.update', $volunteer->id], 'class' => '']) !!}
    <div class="row">
        <div class="col-md-8">
            <!-- Horizontal Form -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h4 class="box-title">Temel Bilgileri</h4>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    ...
                    {!! Form::submit("Güncelle", ['class' => 'btn btn-ls btn-block btn-lg']) !!}
                </div>
                <!-- /.box-body -->
            </div>
        </div>

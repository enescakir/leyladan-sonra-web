  ...
  <div class="row">
    <div class="col-xs-12">
        ...
        <div class="box-header with-border">
          ...
          <div class="box-tools">
            <div class="input-group input-group-sm">
              <input type="text" id="test-number" class="form-control mobile pull-right" style="max-width:200px;" name="test-number" placeholder="Test Numarası">
              <div class="input-group-btn">
                <button id="send-test" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Test Et</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-body -->
        <div class="box-footer">
          <a href="#sms-send" class="btn btn-default pull-right"><i class="fa fa-arrow-up"></i> Yukarıya Çık</a>
        </div>
        <!-- /.box-footer -->
      </div>
      <!-- /.box -->

...
@section('content')
  ...
  @forelse($materials->chunk(4) as $chunk)
        ...
        <div id="material-{{ $material->id }}" class="col-xs-6 col-sm-3">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <div class="btn-group btn-group-xs">
                  <a class="edit btn btn-warning btn-xs" href="{{ route("admin.material.edit", $material->id) }}">
                    <i class="fa fa-pencil"></i>
                  </a>
                  <a class="delete btn btn-danger btn-xs" delete-id="{{ $material->id }}" delete-name="{{ $material->name }}" href="javascript:;">
            ...
            <div class="box-body no-padding text-center">
                <img class="img-responsive" style="margin:auto" src="{{ $material->image_url }}" alt="{{ $material->name }}">
            </div>
          </div>
        </div>
      @endforeach
    ...
    @empty
    <h2>Bu kriterlere uygun tanıtım materyali bulunamadı</h2>
  @endforelse

...
@section('title', 'Eğitim Güncelleme')

@section('header')
<section class="content-header">
  <h1>
  Eğitim Güncelleme
  <small>Bu sayfadan sistemdeki eğitim videosunu güncelleyebilirsiniz</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i> Anasayfa</a></li>
    <li><a href="{{ route('admin.tutorial.index') }}">Eğitimler</a></li>
    <li class="active">Eğitim Güncelle</li>
  </ol>
</section>
@endsection
...
<div class="row">
  <div class="col-md-8">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      {!! Form::model($tutorial, ['method' => 'PUT', 'route' => ['admin.tutorial.update', $tutorial->id], 'class' => 'form-horizontal', 'files' => true]) !!}
      <div class="box-body">

    ...
    <div class="col-xs-12">
      @component('admin.partials.box.default')
        ...
        @slot('filters')
          ...
          <a href="{{ route('admin.wish-category.create') }}" class="btn btn-success"><i class="fa fa-plus"></i></a>
        @endslot
            ...
            @slot('body')
              @forelse ($categories as $category)
                <tr id="wish-category-{{ $category->id }}">
                  ...
                  <td>
                    <div class="btn-group">
                      <a class="edit btn btn-warning btn-xs" href="{{ route("admin.wish-category.edit", $category->id) }}">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <a class="delete btn btn-danger btn-xs"
                        delete-id="{{ $category->id }}" delete-name="{{ $category->name }}" href="javascript:;">

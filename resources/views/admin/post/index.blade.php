...
<section class="content-header">
  <h1>
    ...
    <small>Sistemimizde bulunan tüm yazılara buradan ulaşabilirsiniz</small>
  </h1>
  <ol class="breadcrumb">
                ...
                <div class="btn-group btn-group-sm">
                  ...
                  <ul class="dropdown-menu scrollable-menu">
                    @foreach ($faculties as $key => $value)
                      <li><a href="{{ request()->fullUrlWithQuery(array_merge(request()->all(), ['faculty_id' => $key])) }}">{{ $value }}</a></li>
                    @endforeach
                  </ul>
                </div>
                {{-- POST TYPE SELECTOR --}}
